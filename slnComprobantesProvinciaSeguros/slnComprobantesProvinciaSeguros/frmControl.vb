    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If errores.Count = 0 Then
            ...
            ElseIf (txtEntrada.Text.Length = 38) Then
                ...
                If ((txtNroCuota.Text = "31" Or txtNroCuota.Text = "32") AndAlso ComprobantesAct.esPagoTarjetaInvalido(dtpFechaVencimiento.Text)) Then

                    MsgBox("No es posible registrar el pago. La fecha maxima para ingresar un pago con tarjeta de credito es hasta el dia 10 del mes de vencimiento.", MsgBoxStyle.Exclamation, "Aviso")
                Else
